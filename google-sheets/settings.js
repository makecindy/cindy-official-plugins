(function () {
  ...
  var MESSAGES = {
    en: {
      accountTitle: 'Google Sheets account',
      separateAuthorization: 'Separate authorization',
      permissionHint: 'Only requests Sheets access and does not grant Gmail, Calendar, or Drive access.',
    ...
    'zh-CN': {
      accountTitle: 'Google Sheets 账号',
      separateAuthorization: '独立授权',
      permissionHint: '只授权 Sheets 权限，不会同时取得 Gmail、Calendar 或 Drive 权限。',
      connectAccount: '连接账号',
    ...
    ja: {
      accountTitle: 'Google Sheets アカウント',
      separateAuthorization: '個別認証',
      permissionHint: 'Sheets の権限のみをリクエストし、Gmail、Calendar、Drive の権限は取得しません。',
    ...
    ko: {
      accountTitle: 'Google Sheets 계정',
      separateAuthorization: '개별 인증',
      permissionHint: 'Sheets 권한만 요청하며 Gmail, Calendar 또는 Drive 권한은 요청하지 않습니다.',
