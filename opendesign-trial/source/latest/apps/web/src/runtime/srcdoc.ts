...
function injectSnapshotBridge(doc: string): string {
  ...
  var SNAPSHOT_STYLE_PROPS = [
    ...
    'color','background-color','visibility','opacity','transform','transform-origin','overflow','overflow-x','overflow-y',
  ...
  function captureSnapshot(opts){
    ...
    return new Promise(function(resolve, reject){
      ...
      // Styles preserve hidden nodes; pruning after script removal mismatches DOM indexes.
