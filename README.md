...
| <img src="./wind-finance/assets/icon.png" width="22" alt=""> | Wind Finance | [`wind-finance`](./wind-finance) | Read-only Wind market data and company profiles through an authorized HTTPS API gateway; staged rollout |
