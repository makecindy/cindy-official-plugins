...
const pluginRoot = new URL('../cindy-github/', import.meta.url);
...
test('GitHub settings follow the host locale with English fallback', () => {
...
test('GitHub localizes controls, status feedback, and runtime notifications', () => {
