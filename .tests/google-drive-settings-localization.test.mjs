...
const settingsHtml = readFileSync(
  new URL('../google-drive/settings.html', import.meta.url),
  'utf8',
);
const settingsSource = readFileSync(
  new URL('../google-drive/settings.js', import.meta.url),
  'utf8',
);
const manifest = JSON.parse(readFileSync(
  new URL('../google-drive/ghost.json', import.meta.url),
  'utf8',
));
...
test('Google Drive settings include complete host-driven translations', () => {
...
test('Google Drive settings localize OAuth errors and preserve safe details', () => {
  assert.match(
...
test('Google Drive settings localization bumps the plugin version', () => {
