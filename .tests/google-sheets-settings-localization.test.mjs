...
const settingsHtml = readFileSync(
  new URL('../google-sheets/settings.html', import.meta.url),
  'utf8',
);
const settingsSource = readFileSync(
  new URL('../google-sheets/settings.js', import.meta.url),
  'utf8',
);
const manifest = JSON.parse(readFileSync(
  new URL('../google-sheets/ghost.json', import.meta.url),
  'utf8',
));
...
test('Google Sheets settings include complete host-driven translations', () => {
...
test('Google Sheets settings localize OAuth errors and preserve safe details', () => {
  assert.match(
...
test('Google Sheets settings localization bumps the plugin version', () => {
