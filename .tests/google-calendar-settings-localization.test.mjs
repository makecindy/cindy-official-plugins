...
const settingsHtml = readFileSync(
  new URL('../google-calendar/settings.html', import.meta.url),
  'utf8',
);
const settingsSource = readFileSync(
  new URL('../google-calendar/settings.js', import.meta.url),
  'utf8',
);
const manifest = JSON.parse(readFileSync(
  new URL('../google-calendar/ghost.json', import.meta.url),
  'utf8',
));
...
test('Google Calendar settings include complete host-driven translations', () => {
...
test('Google Calendar settings localize OAuth errors and preserve safe details', () => {
  assert.match(
...
test('Google Calendar settings localization bumps the plugin version', () => {
