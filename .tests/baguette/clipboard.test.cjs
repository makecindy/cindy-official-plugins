...
test('browser paste/copy reach scoped bridge; focus and capability checks prevent accidental actions',async()=>{
 ...
 try{
  ...
  vm.runInNewContext(fs.readFileSync(require.resolve('../../baguette-simulator/vendor/baguette-v0.2.0-macOS-arm64/Baguette_Baguette.bundle/Web/baguette/parts/keyboard.js'),'utf8'),context);
