...
| <img src="./cindy-web-search/assets/icon.png" width="22" alt=""> | Web Search | [`cindy-web-search`](./cindy-web-search) | 公网搜索（默认 Cindy AI，可选 Brave / Tavily Key），以及必须使用 Tavily Key 的单页正文读取 |
