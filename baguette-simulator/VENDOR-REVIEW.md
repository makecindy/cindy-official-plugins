...
`vendor-web.patch` is the complete diff against `Sources/Baguette/Resources/Web` at tag v0.1.98 (commit `5975fa510a5083956f99e25544b6583f296228dd`). Only these seven Web files differ:
...
- `nominatim.openstreetmap.org`, `tile.openstreetmap.org`: pre-existing optional location search and map tiles (`sim-location.js`). User-triggered upstream page functionality.
- `fonts.googleapis.com`, `fonts.gstatic.com`: pre-existing farm-page font resources (`farm/farm.html`).
