(function () {
  ...
  var MESSAGES = {
    en: {
      accountTitle: 'Google Calendar account',
      separateAuthorization: 'Separate authorization',
      permissionHint: 'Only requests Calendar access and does not grant Gmail, Drive, or Sheets access.',
    ...
    'zh-CN': {
      accountTitle: 'Google Calendar 账号',
      separateAuthorization: '独立授权',
      permissionHint: '只授权 Calendar 权限，不会同时取得 Gmail、Drive 或 Sheets 权限。',
      connectAccount: '连接账号',
    ...
    ja: {
      accountTitle: 'Google Calendar アカウント',
      separateAuthorization: '個別認証',
      permissionHint: 'Calendar の権限のみをリクエストし、Gmail、Drive、Sheets の権限は取得しません。',
    ...
    ko: {
      accountTitle: 'Google Calendar 계정',
      separateAuthorization: '개별 인증',
      permissionHint: 'Calendar 권한만 요청하며 Gmail, Drive 또는 Sheets 권한은 요청하지 않습니다.',
