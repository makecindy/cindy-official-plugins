(function () {
  ...
  var MESSAGES = {
    en: {
      accountTitle: 'Google Drive account',
      separateAuthorization: 'Separate authorization',
      permissionHint: 'Only requests Drive access and does not grant Gmail, Calendar, or Sheets access.',
    ...
    'zh-CN': {
      accountTitle: 'Google Drive 账号',
      separateAuthorization: '独立授权',
      permissionHint: '只授权 Drive 权限，不会同时取得 Gmail、Calendar 或 Sheets 权限。',
      connectAccount: '连接账号',
    ...
    ja: {
      accountTitle: 'Google Drive アカウント',
      separateAuthorization: '個別認証',
      permissionHint: 'Drive の権限のみをリクエストし、Gmail、Calendar、Sheets の権限は取得しません。',
    ...
    ko: {
      accountTitle: 'Google Drive 계정',
      separateAuthorization: '개별 인증',
      permissionHint: 'Drive 권한만 요청하며 Gmail, Calendar 또는 Sheets 권한은 요청하지 않습니다.',
